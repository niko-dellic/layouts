...
- `quilt-core-0.1.1.tgz`
- `quilt-vanilla-0.1.1.tgz`
- `quilt-react-0.1.1.tgz`
...
```sh
npm install ./vendor/quilt/quilt-core-0.1.1.tgz \
  ./vendor/quilt/quilt-vanilla-0.1.1.tgz
```
...
npm install ./vendor/quilt/quilt-core-0.1.1.tgz \
  ./vendor/quilt/quilt-vanilla-0.1.1.tgz \
  ./vendor/quilt/quilt-react-0.1.1.tgz react react-dom
```
...
{
  "dependencies": {
    "quilt-core": "file:vendor/quilt/quilt-core-0.1.1.tgz",
    "quilt-vanilla": "file:vendor/quilt/quilt-vanilla-0.1.1.tgz"
  }
}
```
